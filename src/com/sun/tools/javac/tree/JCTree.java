...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    /**
     * A ( ) ? ( ) : ( ) conditional expression 三目运算符
     */
    ...
    /**
     * A parenthesized subexpression ( ... ) 括号表达式
     */
    ...
    /**
     * A constant value given literally. 常量
    ...
    /**
     * Identifies a basic type. 基本数据类型
    ...
    /**
     * A parameterized type, T<...> 参数化类型(泛型)
     */
